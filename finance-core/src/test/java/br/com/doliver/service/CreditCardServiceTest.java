...
class CreditCardServiceTest {
    ...
    void shouldCreateCreditCardWithSuccess() {
        ...
        final CreditCard creditCardCreated = service.create(creditCard);

        assertAll(
            () -> assertEquals(creditCardCreated.getAlias(), creditCard.getAlias(), "Apelido do cartão criado deve ser "
                + "igual ao informado"),
            () -> assertNotNull(creditCardCreated.getId(), "ID do cartão não deve ser nulo"),
