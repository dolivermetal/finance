...
class PersonServiceTest {
    ...
    void shouldCreatePersonWithSuccess() {
        ...
        final Person personCreated = service.create(person);

        assertAll(
            () -> assertEquals(personCreated.getName(), person.getName(), "Nome da pessoa criada deve ser igual ao "
                + "informado"),
            () -> assertNotNull(personCreated.getId(), "ID da pessoa não deve ser nulo"),
