...
@NoArgsConstructor
public class OutboxOracleEntity implements Outbox {
  ...
  public OutboxOracleEntity(final OutboxEntity outbox) {
  ...
  public OutboxOracleEntity(final TransactionOracleEntity transaction) {
